...
<head>
    ...
    <title><?= $data['title'] ?? 'BKK DOSQLA'; ?></title>
    ...
    <style>
        ...
        @keyframes waterWave {
            ...
            33% { transform: translateY(-4px) rotate(-1.5deg) scale(1.02); }
            66% { transform: translateY(3px) rotate(1.5deg) scale(0.98); }
            100% { transform: translateY(-2px) rotate(-0.8deg) scale(1.01); }
        }
...
<body>
    ...
    <div class="hero-wrapper">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                    <ul class="navbar-nav align-items-center gap-2 nav-menu-wrapper" id="navMenu">
                        ...
                        <li class="nav-item">
                            <a class="nav-link nav-link-custom wavy-text" href="<?= defined('BASEURL') ? BASEURL : ''; ?>home">Beranda</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link nav-link-custom active-pill wavy-text" href="<?= defined('BASEURL') ? BASEURL : ''; ?>job">Lowongan</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link nav-link-custom wavy-text" href="<?= defined('BASEURL') ? BASEURL : ''; ?>artikel">Artikel</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link nav-link-custom wavy-text" href="<?= defined('BASEURL') ? BASEURL : ''; ?>daftar">Daftar</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link nav-link-custom wavy-text" href="<?= defined('BASEURL') ? BASEURL : ''; ?>auth/login">Login</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <!-- SCRIPT FAILSAFE PRELOADER (TIDAK AKAN MACET LAGI) -->
<script>
    ...
    // 1. Sembunyikan jika semua halaman selesai di-load
    window.addEventListener('load', hidePreloader);

    // 2. FAILSAFE: Paksa sembunyikan setelah 1.5 detik jika ada gambar/aset yang stuck
