<?php 
// 1. Tentukan judul halaman & role yang diizinkan (Opsional, dibaca oleh header.php)
$pageTitle = "Daftar Lowongan Pekerjaan - BKK Dosqla";

// 2. panggil header.php
require_once __DIR__ . '/../ekstra/header.php'; 
?>
...
<div class="container mx-auto max-w-4xl my-6 px-4">
    <h2 class="text-2xl font-bold text-center mb-6 text-gray-800">Cari Lowongan Pekerjaan</h2>
...
<?php if ($role === 'admin'): ?>
    </div> <!-- Menutup div .main-content milik layout Admin di header.php -->
<?php endif; ?>